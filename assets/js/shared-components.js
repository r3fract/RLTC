...
const sharedFooterHTML = `
  <footer class="shared-footer">
    <div class="shared-footer-content">
      <p><a href="/">Rainy Lake Trading Co.</a> • <a href="https://pineandstonestays.ca">Pine & Stone Stays</a> • <a href="/about">About Riley</a> • <a href="https://order.penaltyboxcanteen.com" target="_blank">Penalty Box Canteen</a></p>
...
function getCurrentPageName() {
  ...
  // If we're on pineandstonestays.ca domain, always show Pine & Stone branding
  if (hostname === 'pineandstonestays.ca' || hostname === 'www.pineandstonestays.ca') {
    return 'pine-stone.html';
  }
  
  // Handle clean URLs on main domain
